...
class ProductViewModel(
    ...
    private val mProducts: LiveData<List<ProductTable>>
...
//this is where we get our response
    ...
    init {
        mProducts = mRepository.allProduct
    }
}

private fun Any?.enqueue(callback: Callback<List<Product>>) {
